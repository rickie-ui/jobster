...
<body class="antialiased bg-[#E6F0F9] h-auto w-full text-[#002745]">
    ...
    <section class="bg-white w-1/3 rounded-xl mt-44 py-4 px-8 mx-auto">
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <button type="submit"
                class="rounded-3xl bg-[#207456] text-white font-bold w-full py-3 hover:opacity-70 text-xl">Create
                account</button>
        </form>

        <p class="text-center my-4 text-sm">
            Already have an account? <a href="{{ route('login') }}" class="text-[#0769C3] hover:underline">Sign in</a>
        </p>
